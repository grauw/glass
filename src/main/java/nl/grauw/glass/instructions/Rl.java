...
public class Rl extends InstructionFactory {
	...
	public InstructionObject createObject(Expression address, Expression arguments) {
		if (Rl_R.ARGUMENTS.check(arguments))
			return new Rl_R(address, arguments.getElement(0));
	...
	public static class Rl_R extends InstructionObject {
		...
		public Rl_R(Expression address, Expression argument) {
			super(address);
		...
		public byte[] getBytes() {
			...
			return indexifyOnlyIndirect(register, 0xCB, 0x10 | register.get8BitCode());
		}
