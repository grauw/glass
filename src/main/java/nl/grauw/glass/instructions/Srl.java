...
public class Srl extends InstructionFactory {
	...
	public InstructionObject createObject(Expression address, Expression arguments) {
		if (Srl_R.ARGUMENTS.check(arguments))
			return new Srl_R(address, arguments.getElement(0));
	...
	public static class Srl_R extends InstructionObject {
		...
		public Srl_R(Expression address, Expression argument) {
			super(address);
		...
		public byte[] getBytes() {
			...
			return indexifyOnlyIndirect(register, 0xCB, 0x38 | register.get8BitCode());
		}
