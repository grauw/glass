...
public class Set extends InstructionFactory {
	...
	public InstructionObject createObject(Expression address, Expression arguments) {
		if (Set_N_R.ARGUMENTS.check(arguments))
			return new Set_N_R(address, arguments.getElement(0), arguments.getElement(1));
	...
	public static class Set_N_R extends InstructionObject {
		...
		public Set_N_R(Expression address, Expression argument1, Expression argument2) {
			super(address);
		...
		public byte[] getBytes() {
			...
			return indexifyOnlyIndirect(register, 0xCB, 0xC0 | value << 3 | register.get8BitCode());
		}
